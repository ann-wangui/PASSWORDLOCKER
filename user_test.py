...
class TestUser(unittest.TestCase):
    ...
    def setUp(self):
        self.new_user = User("annwangui","a@Z3603",[])
    ...
    def test_init(self):
        self.assertEqual(self.new_user.username,"annwangui")
        self.assertEqual(self.new_user.password,"a@Z3603")
    ...
    def test_save_multiple_users(self):
        self.new_user.save_user()
        test_user = User("annwangui","annzpO3",[])
        test_user.save_user()
    ...
    def test_user_exists(self):
        ...
        user_exist = User.user_exists("annwangui")
    ...
    def test_find_user(self):
        ...
        find_user = User.find_user("annwangui")
